...
In order to learn something about R, I have prepared some data exploration tasks for you, using the `mpg` data frame found in ggplot2 (aka `ggplot2::mpg`).
...
Enough of the theory for now, lets get back to practice!
...
Writing functions is not easy and requires practice!
